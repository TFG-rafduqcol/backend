...
const deployTower = async (req, res) => {
    ...
    try {
        ...
        const towerProperties = {
            stoneCannon: { cost: 100, damage: 10, fire_rate: 1.5, range: 140, projectile_type: 'stone' },
            ironCannon: { cost: 125,  damage: 12, fire_rate: 2, range: 120, projectile_type: 'iron' },
            inferno: { cost: 150,  damage: 13, fire_rate: 3, range: 120, projectile_type: 'fire' },
            mortar: { cost: 120,  damage: 14.5, fire_rate: 4, range: 110, projectile_type: 'rock' },
        };
